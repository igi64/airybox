(function (GLOBAL) {
    ...
    JSUnzip.COMPRESSION_METHOD_STORE = 0x00;
    JSUnzip.COMPRESSION_METHOD_DEFLATE = 0x08;
    JSUnzip.COMPRESSION_METHOD_JSON = 0x15;
    ...
    JSUnzip.ZipEntry = function (binaryStream) {
        ...
        if (!(this.compressionMethod === JSUnzip.COMPRESSION_METHOD_STORE ||
            this.compressionMethod === JSUnzip.COMPRESSION_METHOD_DEFLATE ||
            this.compressionMethod === JSUnzip.COMPRESSION_METHOD_JSON)) {
            throw "File is using compression method " + this.compressionMethod + ". Not supported.";
        }

        if (this.isEncrypted() && (this.compressionMethod != JSUnzip.COMPRESSION_METHOD_JSON)) {
